...
<div class="quick-actions">
  ...
  <a class="glass-btn primary" href="{{ '/teaching/' | relative_url }}">Teaching</a>
</div>

<div class="jump-menu glass-panel">
  <a class="jump-chip" href="#graduate-classes">Graduate Classes</a>
  <a class="jump-chip" href="#undergraduate-classes">Undergraduate Classes</a>
</div>
